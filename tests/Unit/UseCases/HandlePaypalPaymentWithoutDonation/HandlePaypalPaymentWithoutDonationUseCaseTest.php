...
class HandlePaypalPaymentWithoutDonationUseCaseTest extends TestCase {
	...
	private function createNotifierExpectingNotification(): DonationConfirmationNotifier {
		$notifier = $this->createMock( DonationConfirmationNotifier::class );
		$notifier->expects( $this->once() )->method( 'sendConfirmationFor' );
		return $notifier;
	}

	private function createNotifierExpectingNoNotification(): DonationConfirmationNotifier {
		$notifier = $this->createMock( DonationConfirmationNotifier::class );
