...
CREATE TABLE payments_paypal (id INT NOT NULL, parent_payment_id INT DEFAULT NULL, valuation_date DATETIME DEFAULT NULL COMMENT '(DC2Type:datetime_immutable)', booking_data LONGTEXT DEFAULT NULL COMMENT '(DC2Type:json)', transaction_id VARCHAR(36) DEFAULT NULL, INDEX IDX_2A359C3C438027EB (parent_payment_id), INDEX ppl_transaction_id (transaction_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB;
