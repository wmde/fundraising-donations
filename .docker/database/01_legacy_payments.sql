...
CREATE TABLE `donation_payment` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=36779 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
/*!40000 ALTER TABLE `donation_payment` ENABLE KEYS */;

--
-- Table structure for table `donation_payment_sofort`
--

DROP TABLE IF EXISTS `donation_payment_sofort`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `donation_payment_sofort`
--

/*!40000 ALTER TABLE `donation_payment_sofort` ENABLE KEYS */;
...
-- Dump completed on 2022-04-21 16:36:24
