...
class DonationContextFactory {
	...
	/**
	 * This is only needed for testing, where the random tokens generated by
	 * DoctrineDonationPrePersistSubscriber make comparing donation Doctrine entities harder
	 */
